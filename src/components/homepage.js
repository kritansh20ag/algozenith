    ...
    <div className="flex flex-col h-screen w-full bg-white">
       ...
       <div className="flex justify-between items-center px-4 py-2 bg-white ">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-[#172b4d] w-[144px] h-[28px] font-bold">AlgoZenith</h1>
        </div>
...
<div className="w-64 bg-gradient-to-t from-[#F2FBFF] to-white">
  <nav className="p-4">
  ...
  <button className="w-[243px] h-[61px] flex items-center space-x-2 bg-transparent rounded-lg transition-all duration-200 hover:bg-white hover:shadow-lg">
    <div className="flex items-center px-5 py-3 gap-2"> {/* Apply padding here */}
      ...
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="flex items-center space-x-3 text-sm">
          ...
          <div 
            ...
            onClick={() => setOpenPart(openPart === part.id ? null : part.id)} // Toggle dropdown
          >
